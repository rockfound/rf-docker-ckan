...
def base_url():
    ''' The base url of the RF service '''
    global _base_url
    if not _base_url:
        _base_url = t.url_for('/datastore/rf3.0/', qualified=True)
    return _base_url


def rf(context, data_dict):
    ...
    if output_json:
        ...
        return t.render('ckanext-rf/collection.xml', data)
